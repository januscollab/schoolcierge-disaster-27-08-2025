...
with_node \
  ...
  --target "/Users/alanmahon/dev.env/projects/schoolcierge/project/ui/showcase/ios/Pods/Target Support Files/Pods-SchoolciergeShowcase/ExpoModulesProvider.swift" \
  --entitlement "/Users/alanmahon/dev.env/projects/schoolcierge/project/ui/showcase/ios/SchoolciergeShowcase/SchoolciergeShowcase.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen"
